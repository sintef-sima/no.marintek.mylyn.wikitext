...
package no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans;

public class RemoteContentPermissionSet  implements java.io.Serializable {
    private no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentPermission[] contentPermissions;
    ...
    public RemoteContentPermissionSet(
           no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentPermission[] contentPermissions,
     ...
     */
    public no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentPermission[] getContentPermissions() {
        return contentPermissions;
    }
     ...
     */
    public void setContentPermissions(no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentPermission[] contentPermissions) {
        this.contentPermissions = contentPermissions;
    }
