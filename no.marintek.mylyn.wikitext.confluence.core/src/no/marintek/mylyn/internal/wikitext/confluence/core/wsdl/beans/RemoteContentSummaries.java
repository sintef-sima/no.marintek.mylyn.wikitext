...
public class RemoteContentSummaries  implements java.io.Serializable {
    private no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentSummary[] content;
    ...
    public RemoteContentSummaries(
           no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentSummary[] content,
           int offset,
           int totalAvailable) {
     ...
     * @return content
     */
    public no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentSummary[] getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(no.marintek.mylyn.internal.wikitext.confluence.core.wsdl.beans.RemoteContentSummary[] content) {
        this.content = content;
    }
