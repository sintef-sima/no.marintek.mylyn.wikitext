 ...
 *     Torkild U. Resheim - Confluence table theming
 *******************************************************************************/
...
public class TableBlock extends Block {
	...
	public int processLineContent(String line, int offset) {
		if (blockLineCount == 0) {
			...
			attributes.setCssStyle("border-style: solid; border-width: 1px; border-color: #ddd;"); // from confluenceTd //$NON-NLS-1$
